...
public class IoSignedInteger extends org.jpac.vioss.IoSignedInteger implements IoSignal{
     ...
     */    
    public IoSignedInteger(AbstractModule containingModule, String identifier, URI uri, IoDirection ioDirection, double samplingRate, ExtensionObject extensionObject, int queueSize, boolean discardOldest) throws SignalAlreadyExistsException, InconsistencyException, WrongUseException{
