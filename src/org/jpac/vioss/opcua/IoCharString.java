...
public class IoCharString extends org.jpac.vioss.IoCharString implements IoSignal{
     ...
     */    
    public IoCharString(AbstractModule containingModule, String identifier, URI uri, IoDirection ioDirection, double samplingRate, ExtensionObject extensionObject, int queueSize, boolean discardOldest) throws SignalAlreadyExistsException, InconsistencyException, WrongUseException, StringLengthException{
