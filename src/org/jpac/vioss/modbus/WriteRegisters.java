 ...
 */
public class WriteRegisters implements Request{
    ...
    public WriteRegisters(Address address, Data writeData){
    ...
    private short getActualTransactionIdentifier(){
     ...
     public static void main(String[] args){
       ...
       try{
           ...
           WriteRegisters wreq = new WriteRegisters(new Address(new DataBlock(DataBlock.DataBlocks.PHYSICALOUTPUTREGISTERS),0,4) , txData);
           long startTime;
           long stopTime;
