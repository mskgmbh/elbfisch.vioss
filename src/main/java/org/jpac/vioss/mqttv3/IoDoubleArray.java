 ...
 * MODULE    : IoDoubleArray.java (versatile input output subsystem)
 * VERSION   : -
 * DATE      : -
 * PURPOSE   : 
...
public class IoDoubleArray extends DoubleArray implements IoSignal {
    private IoSignalImpl ioSignalImpl;

    public IoDoubleArray(AbstractModule containingModule, String identifier, URI uri, IoDirection ioDirection) throws SignalAlreadyExistsException, InconsistencyException, WrongUseException {
	...
	@Override
	public void setRemoteSignalInfo(org.jpac.vioss.RemoteSignalInfo remoteSignalInfo) {
		ioSignalImpl.setRemoteSignalInfo((RemoteSignalInfo)remoteSignalInfo);
	}
