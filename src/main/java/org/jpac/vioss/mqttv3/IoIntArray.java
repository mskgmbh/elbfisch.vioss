 ...
 * MODULE    : IoIntArray.java (versatile input output subsystem)
 * VERSION   : -
 * DATE      : -
 * PURPOSE   : 
...
public class IoIntArray extends IntArray implements IoSignal {
    private IoSignalImpl ioSignalImpl;

    public IoIntArray(AbstractModule containingModule, String identifier, URI uri, IoDirection ioDirection) throws SignalAlreadyExistsException, InconsistencyException, WrongUseException {
