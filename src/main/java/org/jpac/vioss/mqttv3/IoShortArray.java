...
public class IoShortArray extends ShortArray implements IoSignal {
    private IoSignalImpl ioSignalImpl;

    public IoShortArray(AbstractModule containingModule, String identifier, URI uri, IoDirection ioDirection) throws SignalAlreadyExistsException, InconsistencyException, WrongUseException {
