 ...
 */
public class ReadDiscreteInputs implements Request{
    ...
    public ReadDiscreteInputs(DataBlock dataBlock){
    ...
    protected void readResponseHeader(Connection conn) throws IOException{
        ...
        if (functionCode != (byte)FunctionCode.READDISCRETEINPUTS.getValue()){
    ...
    private short getActualTransactionIdentifier(){
     ...
     public static void main(String[] args){
       ...
       try{
           ...
           ReadDiscreteInputs rwreq = new ReadDiscreteInputs(new DataBlock(0,2,FunctionCode.READCOILS,FunctionCode.UNDEFINED, new Iec61131Address("%IW0")));
           long startTime;
           long stopTime;
