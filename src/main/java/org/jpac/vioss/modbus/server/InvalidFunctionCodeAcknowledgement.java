 ...
 * MODULE    : modbus server InvalidFunctionCodeAcknowledgement.java (versatile input output subsystem)
 * VERSION   : -
 * DATE      : -
 * PURPOSE   : 
 ...
 */
public class InvalidFunctionCodeAcknowledgement extends Acknowledgement{
