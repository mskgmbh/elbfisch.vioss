 ...
 * MODULE    : modbus server GeneralErrorAcknowledgement.java (versatile input output subsystem)
 * VERSION   : -
 * DATE      : -
 * PURPOSE   : 
 ...
 */
public class FunctionFailedAcknowledgement extends Acknowledgement{
    protected int fctCode;
    
    public FunctionFailedAcknowledgement(int fctCode){
