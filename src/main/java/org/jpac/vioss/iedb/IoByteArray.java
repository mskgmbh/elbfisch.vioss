...
public class IoByteArray extends ByteArray implements IoSignal {
    private IoSignalImpl ioSignalImpl;

    public IoByteArray(AbstractModule containingModule, String identifier, URI uri, IoDirection ioDirection) throws SignalAlreadyExistsException, InconsistencyException, WrongUseException {
