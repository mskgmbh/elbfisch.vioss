 ...
 * MODULE    : IoFloatArray.java (versatile input output subsystem)
 * VERSION   : -
 * DATE      : -
 * PURPOSE   : 
...
public class IoFloatArray extends FloatArray implements IoSignal {
    private IoSignalImpl ioSignalImpl;

    public IoFloatArray(AbstractModule containingModule, String identifier, URI uri, IoDirection ioDirection) throws SignalAlreadyExistsException, InconsistencyException, WrongUseException {
