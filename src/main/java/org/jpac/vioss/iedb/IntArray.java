 ...
 * MODULE    : IntArray.java (versatile input output subsystem)
 * VERSION   : -
 * DATE      : -
 * PURPOSE   : 
...
public class IntArray extends Generic<int[]> {
    private IntArrayValue wrapperValue;
/**
     * constructs a IntArray signal
     ...
     */
    public IntArray(AbstractModule containingModule, String identifier, IoDirection ioDirection) throws SignalAlreadyExistsException{
        super(containingModule, identifier, ioDirection);
        this.wrapperValue       = new IntArrayValue();
    }

/**
     * used to set the int array to the given value
     * @param value: value, the int array is set to
     * @throws org.jpac.SignalAccessException when a given module is not allowed to set the signal
     */
    public void set(int[] value) throws SignalAccessException{
        synchronized(this){
    ...
    /**
     * used to set the IntArray from any thread, which is not a module and not the jPac thread
     * The value is changed synchronized to the jPac cycle
     * @param value: value, the IntArray is set to
     */
    public void setDeferred(int[] value){
        IntArrayValue localWrapperValue = new IntArrayValue();
    ...
    /**
     * returns the value of the IntArray. If the calling module is the containing module the value of this signal is returned.
    ...
    public int[] get() throws SignalInvalidException{
        return ((IntArray)getValidatedValue()).get();
    }
     ...
     */
    public void setIntrinsicFunction(Supplier<int[]> intrinsicFunction){
    ...
    /**
     * used to connect this int array to another int array. One int array can be connected
     * to multiple int arrays.
     ...
     */
    public void connect(IntArray targetSignal) throws SignalAlreadyConnectedException{
    ...
    protected boolean isCompatibleSignal(Signal signal) {
        return signal instanceof IntArray;
    }

    @Override
    protected void propagateSignalInternally() {
        //physically copy the value to the propagated value
        ((IntArrayValue)getPropagatedValue()).copy((IntArrayValue)getValue());
    }
